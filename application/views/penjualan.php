                    ...
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            <div class="add_button ms-2">
                                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahPembelian">Tambah Penjualan</a>
                            </div>
                        </div>
                    </div>
                    <div class="QA_table ">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahPembelianTitle">Tambah Data Pembelian Spare Part</h5>
                    ...
                    <form id="input-form">
                        <div id="product_row1" class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" id="investor" name="investor" onchange="updatePeriodeOptions()">
                                            ...
                                            <?php foreach ($investor as $key) : ?>
                                                <option value="<?php echo $key->investor; ?>"><?php echo $key->investor; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-4">
                                        <input id="nama_item1" type="text" class="form-control" placeholder="Nama Item/Barang" required>
                                    </div>
                                    <input id="satuan" type="hidden" class="form-control" value="ekor">
    ...
    <div class="modal fade" id="hapusData<?= $key->id_transaksi; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="hapusData<?= $key->id_transaksi; ?>Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url(); ?>penjualan/hapus_data/<?= $key->id_transaksi; ?>">
                    <div class="modal-body">
...
<script>
        ...
        if (validateInputs()) {
            ...
            <div id="product_row${counter}" class="row">
                <div class="col-md-4 mt-1">
                    <input id="nama_item${counter}" type="text" class="form-control" placeholder="Nama Item/Barang" required>
                </div>
    ...
    function validateInputs() {
        for (var i = 1; i <= counter; i++) {
            ...
            if (nama_item && investor && periode && jumlah_item && harga_satuan) {
                ...
                if (nama_item === '' || investor === '' || periode === '' || jumlah_item === '' || harga_satuan === '' || satuan === '') {
    ...
    function submit_form() {
        if (validateInputs()) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url("penjualan/save_purchase"); ?>',
                data: {
...
<script>
    $(document).on("click", "#generatePDFBtn", function() {
        ...
        window.location.href = "<?= base_url('penjualan/cetakPDF'); ?>";
    });
</script>
    ...
    $('.delete-btn').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '<?= base_url() ?>penjualan/delete_penjualan/' + id;
            }
        });
    });
</script>
...
<script>
    function updatePeriodeOptions() {
        ...
        // Fetch the data for the selected investor
        var selectedInvestorData = <?php echo json_encode($investor); ?>;

        // Find the selected investor in the array
        var investorData = selectedInvestorData.find(function(item) {
            return item.investor === selectedInvestor;
        });

        // Clear existing options
        periodeDropdown.innerHTML = '<option disabled selected="selected"> - Pilih Periode - </option>';

        // Add options for the selected investor's periodes
        if (investorData) {
            var periodes = investorData.periode.split(',');
